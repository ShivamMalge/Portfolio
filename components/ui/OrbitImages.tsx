...
export default function OrbitImages({
  ...
  const designCenterY = (baseHeight || baseWidth) / 2;
  ...
  return (
    <div
      ...
      style={{
        ...
        aspectRatio: responsive ? `${baseWidth} / ${baseHeight || baseWidth}` : undefined,
      }}
      aria-hidden="true"
    >
      <div
        ...
        style={{
          ...
          height: responsive ? (baseHeight || baseWidth) : '100%',
        ...
        >
          {showPath && (
            <svg
              width="100%"
              height="100%"
              viewBox={`0 0 ${baseWidth} ${baseHeight || baseWidth}`}
